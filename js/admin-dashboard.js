            ...
            <tr>
                ...
                <td>
                    <div class="location-info">
                        <div class="main-location">${login.city || '未知城市'}, ${login.country || '未知国家'}</div>
                        <div class="detail-location" style="font-size: 11px; color: rgba(255,255,255,0.6);">
                            ${login.region || '未知地区'} • ${login.isp || '未知运营商'}
                        </div>
                    </div>
                </td>
                <td>
    ...
    renderRegistrationHistory() {
        ...
        tbody.innerHTML = this.registrationHistory.map(reg => `
            <tr>
                ...
                <td>
                    <div class="location-info">
                        <div class="main-location">${reg.city || '未知城市'}, ${reg.country || '未知国家'}</div>
                        <div class="detail-location" style="font-size: 11px; color: rgba(255,255,255,0.6);">
                            ${reg.region || '未知地区'} • ${reg.isp || '未知运营商'}
                        </div>
                    </div>
                </td>
                <td>
                ...
                <td>${reg.latitude && reg.longitude ?
                    `<a href="https://maps.google.com/?q=${reg.latitude},${reg.longitude}" target="_blank" style="color: #e74c3c;">
